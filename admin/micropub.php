...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'generate') {
        ...
        $justIssued = $token;
        $flash      = 'New Micropub token generated. Copy it now — it will not be shown again.';
...
<head>
    ...
    <title>Micropub — <?= Helpers::e($siteTitle) ?></title>
...
<main class="admin-main">
    <header class="page-header">
        <h1>Micropub / iA Writer</h1>
    </header>

    <?php if ($flash !== ''): ?>
        <p class="alert alert--<?= Helpers::e($flashType) ?>"><?= Helpers::e($flash) ?></p>
    <?php endif; ?>
    ...
    <p class="alert alert--error">
        ...
        <a href="/admin/settings.php">Set it in Settings →</a>
    </p>
    <?php endif; ?>
    ...
    <div class="panel">
        ...
        <form method="post" action="/admin/micropub.php" style="display:flex;gap:.5rem;flex-wrap:wrap">
